...
hw_refreshVideo();
    ...
    vt100_puts("\e[20;1H#\e[21;1H#\e[22;1H#\e[23;1H#\e[24;1H#");
    vt100_puts("\e[20;80H#\e[21;80H#\e[22;80H#\e[23;80H#\e[24;80H#");
    vt100_puts("\e[1;1H");

hw_refreshVideo();

    for(int x = 0; x < VT100_WIDTH; x++)
        vt100_putc('#');
    vt100_puts("\e[3;1H");
    for(int x = 0; x < VT100_WIDTH; x++)
        vt100_putc('#');
...
hw_refreshVideo();
    ...
    vt100_puts("\e[23;3HThis is bottom text (should not move)");
...
hw_refreshVideo();
    ...
    // print some text that should not move
    vt100_puts("\e[2;4HThis is top text (should not move)");
    vt100_puts("\e[22;3HThis is bottom text (should not move)");
